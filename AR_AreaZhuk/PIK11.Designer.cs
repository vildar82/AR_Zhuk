...
SELECT ID_Section, ID_Flat, SelectedIndexBottom, SelectedIndexTop, ID_FlatInSection FROM F_nn_FlatsInSection WHERE (ID_FlatInSection = @ID_FlatInSection)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4].CommandText = @"UPDATE       F_nn_FlatsInSection
SET                ID_Flat = 3205
FROM            F_nn_FlatsInSection INNER JOIN
                         C_Sections ON F_nn_FlatsInSection.ID_Section = C_Sections.ID_Section
WHERE        (C_Sections.Type = N'Угловая право') AND (F_nn_FlatsInSection.ID_Flat = 3202); 
SELECT ID_Section, ID_Flat, SelectedIndexBottom, SelectedIndexTop, ID_FlatInSection FROM F_nn_FlatsInSection WHERE (ID_FlatInSection = @ID_FlatInSection)";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID_FlatInSection", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "ID_FlatInSection", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        public virtual int UpdateQuery(int ID_FlatInSection) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[4];
            command.Parameters[0].Value = ((int)(ID_FlatInSection));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
...
VALUES        (@Type,@ShortType,@AreaLive,@AreaTotalStandart,@AreaTotalStrong,@AreaInModule,@SelectedIndexBottom,@SelectedIndexTop,@LinkageBefore,@LinkageAfter,@FactorSmoke,@LightBottom,@LightTop,@IndexTop,@IndexBottom,@SubZone,@LinkageOr);     ";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LinkageOr", global::System.Data.SqlDbType.NChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "LinkageOr", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
...
";
    ...
    public partial class C_SectionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        ID_Section, CountModules, Type, Levels, Include\r\nFROM            C_" +
                "Sections";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT CountModules, ID_Section, Include, Levels, Type FROM C_Sections WHERE (Lev" +
                "els = @Level) AND (Type = @Type) AND (CountModules = @CountModule)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
